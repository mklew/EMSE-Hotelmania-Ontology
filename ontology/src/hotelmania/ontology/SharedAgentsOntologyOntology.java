...
public class SharedAgentsOntologyOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String CONTENTELEMENTLIST="ContentElementList";
    ...
    public static final String QUERYHOTELMANIAINFORMATION="QueryHotelmaniaInformation";
  ...
  */
  private SharedAgentsOntologyOntology(){ 
    ...
    AgentActionSchema queryHotelmaniaInformationSchema = new AgentActionSchema(QUERYHOTELMANIAINFORMATION);
    add(queryHotelmaniaInformationSchema, hotelmania.ontology.QueryHotelmaniaInformation.class);
    ...
    PredicateSchema contentElementListSchema = new PredicateSchema(CONTENTELEMENTLIST);
    add(contentElementListSchema, hotelmania.ontology.ContentElementList.class);
